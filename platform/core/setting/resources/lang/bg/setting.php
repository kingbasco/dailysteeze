...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Показване на съветника за начало',
            'show_get_started_helper' => 'Показване на съветника за настройка на таблото за нови инсталации',
    ...
    'email' => [
        ...
        'mail_gun_secret_placeholder' => 'Напр.: your_mailgun_api_key_here',
        ...
        'sendgrid_key' => 'API ключ',
        'sendgrid_key_placeholder' => 'Напр.: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Вашият API ключ за SendGrid',
        'default_locale' => 'Език на имейла по подразбиране',
        'default_locale_helper' => 'Изберете езика по подразбиране за имейлите на клиентите. Когато е зададено на "Автоматично", системата ще използва езика на сайта по подразбиране. Това предотвратява изпращането на имейли на клиенти на езика на таблото за управление на служителя.',
        'default_locale_auto' => 'Автоматично (използване на езика на сайта по подразбиране)',
        ...
        'template_test' => 'Тестов имейл',
        'template_test_description' => 'Шаблон за тестови имейли, изпратени от настройките за имейл',
        'template_test_subject' => 'Тестов имейл от {{ site_title }}',
        'test_email_title' => 'Тест на имейл конфигурацията',
        'test_email_message' => 'Това е тестов имейл, изпратен от :site_title, за да потвърди, че вашите настройки за имейл са конфигурирани правилно.',
        'test_email_success_message' => 'Ако сте получили този имейл, това означава, че вашата SMTP конфигурация работи правилно.',
        'default' => 'По подразбиране',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Wasabi CDN активиран ли е?',
        'wasabi_cdn_enabled_helper' => 'Когато е активирано, медийните файлове ще се обслужват чрез CDN за по-бързо глобално доставяне на съдържание. Трябва да конфигурирате потребителски CDN домейн по-долу.',
        'media_wasabi_cdn_custom_domain' => 'Персонализиран домейн на Wasabi CDN',
        ...
        'image_quality' => 'Качество на изображението',
        'image_quality_helper' => 'Задайте качеството за кодиране на изображения (70-100). По-ниските стойности създават по-малки файлове. По подразбиране е 75. Прилага се за качени изображения, миниатюри и изображения с воден знак.',
    ...
    'generate_thumbnails_override' => 'Замяна на съществуващите миниатюри',
    'generate_thumbnails_override_helper' => 'Ако е отметнато, съществуващите миниатюри ще бъдат генерирани отново. В противен случай ще бъдат създадени само липсващите миниатюри.',
    'generate_thumbnails_batch_size' => 'Размер на партидата',
    'generate_thumbnails_batch_size_helper' => 'Брой изображения за обработка на партида. Увеличете за по-бърза обработка, ако сървърът ви може да го поеме.',
    'generate_thumbnails_start_offset' => 'Начално отместване',
    'generate_thumbnails_start_offset_helper' => 'Пропуснете този брой изображения от началото. Полезно за възобновяване след изтичане на времето.',
    ...
    'cache' => [
        ...
        'form' => [
            ...
            'cache_size_warning_threshold' => 'Праг за предупреждение за размера на кеша (MB)',
            'cache_size_warning_threshold_helper' => 'Показва предупреждение на страницата за управление на кеша, когато кешът на фреймуърка надхвърли този размер (в MB). По подразбиране е 50 MB.',
            'cache_auto_clear_enabled' => 'Автоматично изчистване на кеша, когато размерът надвиши прага',
            'cache_auto_clear_enabled_helper' => 'Автоматично изчиства кеша на фреймуърка на всеки час, когато размерът му надвиши прага за предупреждение по-горе. Изисква планировщикът на Laravel (<code>php artisan schedule:run</code>) да бъде конфигуриран като cron задача на вашия сървър.',
        ],
    ],
    'appearance' => [
        'title' => 'Външен вид',
