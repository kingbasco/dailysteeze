...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Ipakita ang Get Started wizard',
            'show_get_started_helper' => 'Ipakita ang Get Started setup wizard sa dashboard para sa mga bagong installation',
    ...
    'email' => [
        ...
        'mail_gun_secret_placeholder' => 'Hal: your_mailgun_api_key_here',
        ...
        'sendgrid_key_placeholder' => 'Hal: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Ang iyong SendGrid API key',
        'default_locale' => 'Default na wika ng email',
        'default_locale_helper' => 'Piliin ang default na wika para sa mga email ng customer. Kapag nakatakda sa "Auto", gagamitin ng sistema ang default na wika ng site. Pinipigilan nito ang pagpapadala ng mga email ng customer sa wika ng dashboard ng staff.',
        'default_locale_auto' => 'Auto (gamitin ang default na wika ng site)',
        ...
        'template_test' => 'Test na email',
        'template_test_description' => 'Template para sa mga test email na ipinadala mula sa mga setting ng email',
        'template_test_subject' => 'Test na email mula sa {{ site_title }}',
        'test_email_title' => 'Pagsubok ng Email Configuration',
        'test_email_message' => 'Ito ay isang test na email na ipinadala mula sa :site_title upang i-verify na ang iyong mga setting ng email ay naka-configure nang tama.',
        'test_email_success_message' => 'Kung natanggap mo ang email na ito, nangangahulugan na ang iyong SMTP configuration ay gumagana nang maayos.',
        'default' => 'Default',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Naka-enable ba ang Wasabi CDN?',
        'wasabi_cdn_enabled_helper' => 'Kapag pinagana, ang mga file ng media ay ihahain sa pamamagitan ng isang CDN para sa mas mabilis na paghahatid ng nilalaman ng pandaigdig. Dapat mong i -configure ang isang pasadyang domain ng CDN sa ibaba.',
        'media_wasabi_cdn_custom_domain' => 'Custom domain ng Wasabi CDN',
        ...
        'backblaze_cdn_enabled_helper' => 'Kapag pinagana, ang mga file ng media ay ihahain sa pamamagitan ng isang CDN para sa mas mabilis na paghahatid ng nilalaman ng pandaigdig. Dapat mong i -configure ang isang pasadyang domain ng CDN sa ibaba.',
        ...
        'image_quality' => 'Kalidad ng imahe',
        'image_quality_helper' => 'Itakda ang kalidad para sa pag-encode ng imahe (70-100). Ang mas mababang halaga ay gumagawa ng mas maliliit na file. Ang default ay 75. Nalalapat ito sa mga na-upload na imahe, thumbnail, at mga imahe na may watermark.',
    ...
    'generate_thumbnails_override' => 'I-override ang mga umiiral na thumbnail',
    'generate_thumbnails_override_helper' => 'Kung naka-check, ang mga umiiral na thumbnail ay muling gagawin. Kung hindi, ang mga nawawalang thumbnail lang ang gagawin.',
    'generate_thumbnails_batch_size' => 'Laki ng batch',
    'generate_thumbnails_batch_size_helper' => 'Bilang ng mga larawang ipoproseso bawat batch. Dagdagan para sa mas mabilis na pagproseso kung kaya ng iyong server.',
    'generate_thumbnails_start_offset' => 'Panimulang offset',
    'generate_thumbnails_start_offset_helper' => 'Laktawan ang ganitong bilang ng mga larawan mula sa simula. Kapaki-pakinabang para sa pagpapatuloy pagkatapos ng timeout.',
