...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'admin_locale_default' => 'Default (follow site language)',
            'admin_locale_helper' => 'Choose the language for the admin panel interface. Select "Default" to follow the site language setting',
            ...
            'show_get_started' => 'Show Get Started wizard',
            'show_get_started_helper' => 'Display the Get Started setup wizard on the dashboard for new installations',
    ...
    'email' => [
        ...
        'sendgrid_key_helper' => 'Your SendGrid API key',

        'default_locale' => 'Default email language',
        'default_locale_helper' => 'Select the default language for customer emails. When set to "Auto", the system will use the default site language. This prevents customer emails from being sent in the staff member\'s dashboard language.',
        'default_locale_auto' => 'Auto (use default site language)',
        ...
        'template_test_description' => 'Template for test emails sent from email settings',
        'template_test_subject' => 'Test email from {{ site_title }}',
        'test_email_title' => 'Email Configuration Test',
        'test_email_message' => 'This is a test email sent from :site_title to verify that your email settings are configured correctly.',
        'test_email_success_message' => 'If you received this email, it means your SMTP configuration is working properly.',
        'default' => 'Default',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Is Wasabi CDN enabled?',
        'wasabi_cdn_enabled_helper' => 'When enabled, media files will be served through a custom CDN domain for faster global content delivery. You must configure a custom CDN domain below.',
        'media_wasabi_cdn_custom_domain' => 'Wasabi CDN custom domain',
        ...
        'image_quality_helper' => 'Set the quality for image encoding (70-100). Lower values produce smaller files. Default is 75. This applies to uploaded images, thumbnails, and watermarked images.',
    ...
    'generate_thumbnails_override' => 'Override existing thumbnails',
    'generate_thumbnails_override_helper' => 'If checked, existing thumbnails will be regenerated. Otherwise, only missing thumbnails will be created.',
    'generate_thumbnails_batch_size' => 'Batch size',
    'generate_thumbnails_batch_size_helper' => 'Number of images to process per batch. Increase for faster processing if your server can handle it.',
    'generate_thumbnails_start_offset' => 'Start offset',
    'generate_thumbnails_start_offset_helper' => 'Skip this number of images from the beginning. Useful for resuming after a timeout.',
    ...
    'cache' => [
        ...
        'form' => [
            ...
            'cache_size_warning_threshold' => 'Cache size warning threshold (MB)',
            'cache_size_warning_threshold_helper' => 'Show a warning on the Cache Management page when the framework cache exceeds this size (in MB). Default is 50 MB.',
            'cache_auto_clear_enabled' => 'Auto-clear cache when size exceeds threshold',
            'cache_auto_clear_enabled_helper' => 'Automatically clear the framework cache every hour when its size exceeds the warning threshold above. Requires the Laravel scheduler (<code>php artisan schedule:run</code>) to be configured as a cron job on your server.',
        ],
    ],
    'appearance' => [
        'title' => 'Appearance',
