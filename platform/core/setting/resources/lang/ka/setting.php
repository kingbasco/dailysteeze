...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'დაწყების ოსტატის ჩვენება',
            'show_get_started_helper' => 'ახალი ინსტალაციებისთვის დაფაზე დაწყების დაყენების ოსტატის ჩვენება',
    ...
    'email' => [
        ...
        'sendgrid_key_helper' => 'თქვენი SendGrid API გასაღები',
        'default_locale' => 'ელ.ფოსტის ნაგულისხმევი ენა',
        'default_locale_helper' => 'აირჩიეთ ნაგულისხმევი ენა მომხმარებლის ელ.ფოსტებისთვის. "ავტომატური" დაყენებისას სისტემა გამოიყენებს საიტის ნაგულისხმევ ენას. ეს ხელს უშლის მომხმარებლის ელ.ფოსტების გაგზავნას თანამშრომლის პანელის ენაზე.',
        'default_locale_auto' => 'ავტომატური (საიტის ნაგულისხმევი ენის გამოყენება)',
        ...
        'template_test' => 'სატესტო ელფოსტა',
        'template_test_description' => 'შაბლონი სატესტო ელფოსტებისთვის, რომლებიც იგზავნება ელფოსტის პარამეტრებიდან',
        'template_test_subject' => 'სატესტო ელფოსტა {{ site_title }}-დან',
        'test_email_title' => 'ელფოსტის კონფიგურაციის ტესტი',
        'test_email_message' => 'ეს არის სატესტო ელფოსტა, გაგზავნილი :site_title-დან, რათა დადასტურდეს, რომ თქვენი ელფოსტის პარამეტრები სწორად არის კონფიგურირებული.',
        'test_email_success_message' => 'თუ მიიღეთ ეს ელფოსტა, ეს ნიშნავს, რომ თქვენი SMTP კონფიგურაცია სწორად მუშაობს.',
        'default' => 'Default',
    ...
    'media' => [
        ...
        'image_quality' => 'სურათის ხარისხი',
        'image_quality_helper' => 'დააყენეთ სურათის კოდირების ხარისხი (70-100). დაბალი მნიშვნელობები ქმნიან უფრო პატარა ფაილებს. ნაგულისხმევი არის 75. ვრცელდება ატვირთულ სურათებზე, მინიატურებზე და წყლის ნიშნიანი სურათებზე.',
    ...
    'generate_thumbnails_override' => 'არსებული მინიატურების გადაწერა',
    'generate_thumbnails_override_helper' => 'თუ მონიშნულია, არსებული მინიატურები ხელახლა შეიქმნება. წინააღმდეგ შემთხვევაში, მხოლოდ დაკარგული მინიატურები შეიქმნება.',
    'generate_thumbnails_batch_size' => 'პარტიის ზომა',
    'generate_thumbnails_batch_size_helper' => 'სურათების რაოდენობა თითოეულ პარტიაში. გაზარდეთ უფრო სწრაფი დამუშავებისთვის, თუ თქვენი სერვერი ამას გაუმკლავდება.',
    'generate_thumbnails_start_offset' => 'საწყისი ოფსეტი',
    'generate_thumbnails_start_offset_helper' => 'გამოტოვეთ ეს რაოდენობის სურათები დასაწყისიდან. სასარგებლოა დროის ამოწურვის შემდეგ გაგრძელებისთვის.',
