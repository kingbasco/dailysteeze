...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Zobraziť sprievodcu začiatkom',
            'show_get_started_helper' => 'Zobraziť sprievodcu nastavením na hlavnom paneli pre nové inštalácie',
    ...
    'email' => [
        ...
        'mail_gun_secret_placeholder' => 'Napr.: your_mailgun_api_key_here',
        ...
        'sendgrid_key' => 'API klúč',
        'sendgrid_key_placeholder' => 'Napr.: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Váš SendGrid API klúč',
        'default_locale' => 'Predvolený jazyk e-mailov',
        'default_locale_helper' => 'Vyberte predvolený jazyk pre e-maily zákazníkom. Pri nastavení na "Automaticky" systém použije predvolený jazyk webu. Tým sa zabráni odosielaniu e-mailov zákazníkom v jazyku panelu zamestnanca.',
        'default_locale_auto' => 'Automaticky (použiť predvolený jazyk webu)',
        ...
        'template_test' => 'Testovací e-mail',
        'template_test_description' => 'Šablóna pre testovacie e-maily odoslané z nastavení e-mailu',
        'template_test_subject' => 'Testovací e-mail z {{ site_title }}',
        'test_email_title' => 'Test konfigurácie e-mailu',
        'test_email_message' => 'Toto je testovací e-mail odoslaný z :site_title na overenie, že vaše nastavenia e-mailu sú správne nakonfigurované.',
        'test_email_success_message' => 'Ak ste dostali tento e-mail, znamená to, že vaša konfigurácia SMTP funguje správne.',
        'default' => 'Predvolené',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Je Wasabi CDN povolené?',
        'wasabi_cdn_enabled_helper' => 'Ak je táto možnosť povolená, mediálne súbory sa budú poskytovať prostredníctvom siete CDN, aby sa globálne doručovalo rýchlejšie. Nižšie musíte nakonfigurovať vlastnú doménu CDN.',
        'media_wasabi_cdn_custom_domain' => 'Wasabi CDN vlastná doména',
        'media_wasabi_cdn_custom_domain_placeholder' => 'https://vasa-vlastna-domena.com',
        ...
        'image_quality' => 'Kvalita obrázka',
        'image_quality_helper' => 'Nastavte kvalitu kódovania obrázkov (70-100). Nižšie hodnoty vytvárajú menšie súbory. Predvolená hodnota je 75. Platí pre nahrané obrázky, miniatúry a obrázky s vodoznakom.',
    ...
    'generate_thumbnails_override' => 'Prepísať existujúce miniatúry',
    'generate_thumbnails_override_helper' => 'Ak je zaškrtnuté, existujúce miniatúry budú znovu vygenerované. Inak budú vytvorené len chýbajúce miniatúry.',
    'generate_thumbnails_batch_size' => 'Veľkosť dávky',
    'generate_thumbnails_batch_size_helper' => 'Počet obrázkov na spracovanie na dávku. Zvýšte pre rýchlejšie spracovanie, ak to váš server zvládne.',
    'generate_thumbnails_start_offset' => 'Počiatočný posun',
    'generate_thumbnails_start_offset_helper' => 'Preskočte tento počet obrázkov od začiatku. Užitočné na obnovenie po vypršaní časového limitu.',
