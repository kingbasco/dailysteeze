...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'शुरू करें विज़ार्ड दिखाएं',
            'show_get_started_helper' => 'नई स्थापनाओं के लिए डैशबोर्ड पर शुरू करें सेटअप विज़ार्ड प्रदर्शित करें',
    ...
    'email' => [
        ...
        'mail_gun_secret_placeholder' => 'उदाहरण: your_mailgun_api_key_here',
        ...
        'sendgrid_key' => 'API कुंजी',
        'sendgrid_key_placeholder' => 'उदाहरण: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'आपकी SendGrid API कुंजी',
        'default_locale' => 'डिफ़ॉल्ट ईमेल भाषा',
        'default_locale_helper' => 'ग्राहक ईमेल के लिए डिफ़ॉल्ट भाषा चुनें। जब "ऑटो" पर सेट किया जाता है, तो सिस्टम साइट की डिफ़ॉल्ट भाषा का उपयोग करेगा। यह कर्मचारी की डैशबोर्ड भाषा में ग्राहक ईमेल भेजने से रोकता है।',
        'default_locale_auto' => 'ऑटो (साइट की डिफ़ॉल्ट भाषा का उपयोग करें)',
        ...
        'template_test' => 'परीक्षण ईमेल',
        'template_test_description' => 'ईमेल सेटिंग्स से भेजे गए परीक्षण ईमेल के लिए टेम्पलेट',
        'template_test_subject' => '{{ site_title }} से परीक्षण ईमेल',
        'test_email_title' => 'ईमेल कॉन्फ़िगरेशन परीक्षण',
        'test_email_message' => 'यह :site_title से भेजा गया एक परीक्षण ईमेल है ताकि यह सत्यापित किया जा सके कि आपकी ईमेल सेटिंग्स सही ढंग से कॉन्फ़िगर की गई हैं।',
        'test_email_success_message' => 'यदि आपने यह ईमेल प्राप्त किया है, तो इसका मतलब है कि आपका SMTP कॉन्फ़िगरेशन ठीक से काम कर रहा है।',
        'default' => 'डिफ़ॉल्ट',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'क्या Wasabi CDN सक्षम है?',
        'wasabi_cdn_enabled_helper' => 'सक्षम होने पर, तेजी से वैश्विक सामग्री वितरण के लिए मीडिया फ़ाइलों को सीडीएन के माध्यम से परोसा जाएगा। आपको नीचे एक कस्टम CDN डोमेन कॉन्फ़िगर करना होगा।',
        'media_wasabi_cdn_custom_domain' => 'Wasabi CDN कस्टम डोमेन',
        ...
        'image_quality_helper' => 'छवि एन्कोडिंग के लिए गुणवत्ता सेट करें (70-100)। कम मान छोटी फ़ाइलें बनाते हैं। डिफ़ॉल्ट 75 है। यह अपलोड की गई छवियों, थंबनेल और वॉटरमार्क वाली छवियों पर लागू होता है।',
    ...
    'generate_thumbnails_override' => 'मौजूदा थंबनेल को ओवरराइड करें',
    'generate_thumbnails_override_helper' => 'यदि चेक किया गया है, तो मौजूदा थंबनेल पुनः बनाए जाएंगे। अन्यथा, केवल गायब थंबनेल बनाए जाएंगे।',
    'generate_thumbnails_batch_size' => 'बैच का आकार',
    'generate_thumbnails_batch_size_helper' => 'प्रति बैच प्रोसेस करने के लिए छवियों की संख्या। यदि आपका सर्वर इसे संभाल सकता है तो तेज़ प्रोसेसिंग के लिए बढ़ाएं।',
    'generate_thumbnails_start_offset' => 'प्रारंभ ऑफसेट',
    'generate_thumbnails_start_offset_helper' => 'शुरुआत से इतनी छवियां छोड़ें। टाइमआउट के बाद फिर से शुरू करने के लिए उपयोगी।',
    ...
    'cache' => [
        ...
        'form' => [
            ...
            'cache_size_warning_threshold' => 'कैश आकार चेतावनी सीमा (MB)',
            'cache_size_warning_threshold_helper' => 'जब फ़्रेमवर्क कैश इस आकार (MB में) से अधिक हो जाए तो कैश प्रबंधन पृष्ठ पर एक चेतावनी दिखाएँ। डिफ़ॉल्ट 50 MB है।',
            'cache_auto_clear_enabled' => 'आकार सीमा से अधिक होने पर कैश को स्वचालित रूप से साफ़ करें',
            'cache_auto_clear_enabled_helper' => 'फ़्रेमवर्क कैश का आकार ऊपर दी गई चेतावनी सीमा से अधिक होने पर हर घंटे स्वचालित रूप से साफ़ करता है। इसके लिए Laravel शेड्यूलर (<code>php artisan schedule:run</code>) को आपके सर्वर पर cron job के रूप में कॉन्फ़िगर किया जाना आवश्यक है।',
        ],
    ],
    'appearance' => [
        'title' => 'दिखावट',
