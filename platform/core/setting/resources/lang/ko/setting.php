...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => '시작 마법사 표시',
            'show_get_started_helper' => '새 설치를 위해 대시보드에 시작 설정 마법사를 표시합니다',
    ...
    'email' => [
        ...
        'mail_gun_secret_placeholder' => '예: your_mailgun_api_key_here',
        ...
        'sendgrid_key_placeholder' => '예: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'SendGrid API 키',
        'default_locale' => '기본 이메일 언어',
        'default_locale_helper' => '고객 이메일의 기본 언어를 선택하세요. "자동"으로 설정하면 시스템은 사이트의 기본 언어를 사용합니다. 이렇게 하면 직원의 대시보드 언어로 고객 이메일이 발송되는 것을 방지합니다.',
        'default_locale_auto' => '자동 (사이트 기본 언어 사용)',
        ...
        'template_test' => '테스트 이메일',
        'template_test_description' => '이메일 설정에서 보낸 테스트 이메일 템플릿',
        'template_test_subject' => '{{ site_title }}에서 보낸 테스트 이메일',
        'test_email_title' => '이메일 구성 테스트',
        'test_email_message' => '이것은 :site_title에서 보낸 테스트 이메일로, 이메일 설정이 올바르게 구성되었는지 확인하기 위한 것입니다.',
        'test_email_success_message' => '이 이메일을 받으셨다면, SMTP 구성이 정상적으로 작동하고 있다는 의미입니다.',
        'default' => '기본',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Wasabi CDN이 활성화되어 있습니까?',
        'wasabi_cdn_enabled_helper' => '활성화되면 더 빠른 글로벌 콘텐츠 전송을 위해 미디어 파일이 CDN을 통해 제공됩니다. 아래에서 사용자 지정 CDN 도메인을 구성해야 합니다.',
        'media_wasabi_cdn_custom_domain' => 'Wasabi CDN 사용자 정의 도메인',
        ...
        'image_quality_helper' => '이미지 인코딩 품질을 설정합니다 (70-100). 낮은 값은 더 작은 파일을 생성합니다. 기본값은 75입니다. 업로드된 이미지, 썸네일 및 워터마크 이미지에 적용됩니다.',
    ...
    'generate_thumbnails_override' => '기존 썸네일 덮어쓰기',
    'generate_thumbnails_override_helper' => '선택하면 기존 썸네일이 다시 생성됩니다. 그렇지 않으면 누락된 썸네일만 생성됩니다.',
    'generate_thumbnails_batch_size' => '배치 크기',
    'generate_thumbnails_batch_size_helper' => '배치당 처리할 이미지 수입니다. 서버가 처리할 수 있다면 더 빠른 처리를 위해 늘리세요.',
    'generate_thumbnails_start_offset' => '시작 오프셋',
    'generate_thumbnails_start_offset_helper' => '처음부터 이 수의 이미지를 건너뜁니다. 시간 초과 후 재개할 때 유용합니다.',
