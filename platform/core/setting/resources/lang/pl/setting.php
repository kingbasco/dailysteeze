...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Pokaż kreatora rozpoczęcia',
            'show_get_started_helper' => 'Wyświetl kreatora konfiguracji rozpoczęcia na pulpicie nawigacyjnym dla nowych instalacji',
    ...
    'email' => [
        ...
        'mail_gun_secret_placeholder' => 'Np.: your_mailgun_api_key_here',
        ...
        'sendgrid_key' => 'Klucz API',
        'sendgrid_key_placeholder' => 'Np.: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Twój klucz API SendGrid',
        'default_locale' => 'Domyślny język e-maili',
        'default_locale_helper' => 'Wybierz domyślny język dla e-maili klientów. Gdy ustawiono na "Auto", system użyje domyślnego języka strony. Zapobiega to wysyłaniu e-maili klientów w języku panelu pracownika.',
        'default_locale_auto' => 'Auto (użyj domyślnego języka strony)',
        ...
        'template_test' => 'Testowy e-mail',
        'template_test_description' => 'Szablon testowych e-maili wysyłanych z ustawień e-mail',
        'template_test_subject' => 'Testowy e-mail z {{ site_title }}',
        'test_email_title' => 'Test konfiguracji e-mail',
        'test_email_message' => 'To jest testowy e-mail wysłany z :site_title w celu sprawdzenia, czy ustawienia e-mail są prawidłowo skonfigurowane.',
        'test_email_success_message' => 'Jeśli otrzymałeś tego e-maila, oznacza to, że konfiguracja SMTP działa prawidłowo.',
        'default' => 'Domyślny',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Czy Wasabi CDN jest włączone?',
        'wasabi_cdn_enabled_helper' => 'Po włączeniu pliki multimedialne będą udostępniane przez sieć CDN w celu szybszego dostarczania treści na całym świecie. Poniżej musisz skonfigurować niestandardową domenę CDN.',
        'media_wasabi_cdn_custom_domain' => 'Wasabi CDN domena niestandardowa',
        'media_wasabi_cdn_custom_domain_placeholder' => 'https://twoja-domena-niestandardowa.com',
        ...
        'image_quality_helper' => 'Ustaw jakość kodowania obrazów (70-100). Niższe wartości tworzą mniejsze pliki. Domyślna wartość to 75. Dotyczy przesłanych obrazów, miniatur i obrazów ze znakiem wodnym.',
    ...
    'generate_thumbnails_override' => 'Nadpisz istniejące miniatury',
    'generate_thumbnails_override_helper' => 'Jeśli zaznaczone, istniejące miniatury zostaną wygenerowane ponownie. W przeciwnym razie zostaną utworzone tylko brakujące miniatury.',
    'generate_thumbnails_batch_size' => 'Rozmiar partii',
    'generate_thumbnails_batch_size_helper' => 'Liczba obrazów do przetworzenia na partię. Zwiększ dla szybszego przetwarzania, jeśli serwer może to obsłużyć.',
    'generate_thumbnails_start_offset' => 'Początkowe przesunięcie',
    'generate_thumbnails_start_offset_helper' => 'Pomiń tę liczbę obrazów od początku. Przydatne do wznowienia po przekroczeniu limitu czasu.',
