...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Прикажи чаробњак за почетак',
            'show_get_started_helper' => 'Прикажи чаробњак за подешавање на контролној табли за нове инсталације',
    ...
    'email' => [
        ...
        'mail_gun_secret_placeholder' => 'Нпр: your_mailgun_api_key_here',
        ...
        'sendgrid_key' => 'API кључ',
        'sendgrid_key_placeholder' => 'Нпр: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Ваш SendGrid API кључ',
        'default_locale' => 'Подразумевани језик е-поште',
        'default_locale_helper' => 'Изаберите подразумевани језик за е-поруке клијентима. Када је постављено на "Аутоматски", систем ће користити подразумевани језик сајта. Ово спречава слање е-порука клијентима на језику контролне табле запосленог.',
        'default_locale_auto' => 'Аутоматски (користи подразумевани језик сајта)',
        ...
        'template_test' => 'Тест е-пошта',
        'template_test_description' => 'Шаблон за тест е-поруке послате из подешавања е-поште',
        'template_test_subject' => 'Тест е-пошта од {{ site_title }}',
        'test_email_title' => 'Тест конфигурације е-поште',
        'test_email_message' => 'Ово је тест е-порука послата са :site_title да би се потврдило да су ваша подешавања е-поште правилно конфигурисана.',
        'test_email_success_message' => 'Ако сте примили ову е-поруку, то значи да ваша SMTP конфигурација исправно функционише.',
        'default' => 'Подразумевано',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Да ли је Wasabi CDN омогућен?',
        'wasabi_cdn_enabled_helper' => 'Када је омогућено, медијске датотеке ће се сервирати преко ЦДН-а ради брже глобалне испоруке садржаја. Морате да конфигуришете прилагођени ЦДН домен у наставку.',
        'media_wasabi_cdn_custom_domain' => 'Wasabi CDN прилагођени домен',
        ...
        'backblaze_cdn_enabled_helper' => 'Када је омогућено, медијске датотеке ће се сервирати преко ЦДН-а ради брже глобалне испоруке садржаја. Морате да конфигуришете прилагођени ЦДН домен у наставку.',
        ...
        'image_quality' => 'Квалитет слике',
        'image_quality_helper' => 'Подесите квалитет кодирања слика (70-100). Ниже вредности стварају мање датотеке. Подразумевано је 75. Примењује се на отпремљене слике, сличице и слике са воденим жигом.',
    ...
    'generate_thumbnails_override' => 'Замени постојеће сличице',
    'generate_thumbnails_override_helper' => 'Ако је означено, постојеће сличице ће бити поново генерисане. У супротном, биће креиране само недостајуће сличице.',
    'generate_thumbnails_batch_size' => 'Величина серије',
    'generate_thumbnails_batch_size_helper' => 'Број слика за обраду по серији. Повећајте за бржу обраду ако ваш сервер може да поднесе.',
    'generate_thumbnails_start_offset' => 'Почетни помак',
    'generate_thumbnails_start_offset_helper' => 'Прескочите овај број слика од почетка. Корисно за наставак након истека времена.',
