...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'הצג אשף התחלה',
            'show_get_started_helper' => 'הצג את אשף ההגדרה של התחלה בלוח הבקרה עבור התקנות חדשות',
    ...
    'email' => [
        ...
        'mail_gun_secret' => 'סוד',
        'mail_gun_secret_placeholder' => 'לדוגמה: your_mailgun_api_key_here',
        ...
        'sendgrid_key' => 'מפתח API',
        'sendgrid_key_placeholder' => 'לדוגמה: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'מפתח ה-API שלך ב-SendGrid',
        'default_locale' => 'שפת אימייל ברירת מחדל',
        'default_locale_helper' => 'בחר את שפת ברירת המחדל עבור אימיילי לקוחות. כאשר מוגדר ל"אוטומטי", המערכת תשתמש בשפת ברירת המחדל של האתר. זה מונע שליחת אימיילי לקוחות בשפת לוח הבקרה של העובד.',
        'default_locale_auto' => 'אוטומטי (שימוש בשפת ברירת המחדל של האתר)',
        ...
        'template_test' => 'דואר אלקטרוני לבדיקה',
        'template_test_description' => 'תבנית עבור הודעות דואר אלקטרוני לבדיקה שנשלחות מהגדרות הדואר האלקטרוני',
        'template_test_subject' => 'דואר אלקטרוני לבדיקה מ-{{ site_title }}',
        'test_email_title' => 'בדיקת תצורת דואר אלקטרוני',
        'test_email_message' => 'זוהי הודעת דואר אלקטרוני לבדיקה שנשלחה מ-:site_title כדי לוודא שהגדרות הדואר האלקטרוני שלך מוגדרות כראוי.',
        'test_email_success_message' => 'אם קיבלת הודעת דואר אלקטרוני זו, משמעות הדבר היא שתצורת ה-SMTP שלך פועלת כראוי.',
        'default' => 'ברירת מחדל',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'האם Wasabi CDN מופעל?',
        ...
        'media_wasabi_cdn_custom_domain' => 'דומיין מותאם אישית של Wasabi CDN',
        ...
        'image_quality_helper' => 'הגדר את האיכות לקידוד תמונות (70-100). ערכים נמוכים יותר מייצרים קבצים קטנים יותר. ברירת המחדל היא 75. חל על תמונות שהועלו, תמונות ממוזערות ותמונות עם סימן מים.',
    ...
    'generate_thumbnails_override' => 'דרוס תמונות ממוזערות קיימות',
    'generate_thumbnails_override_helper' => 'אם מסומן, התמונות הממוזערות הקיימות ייוצרו מחדש. אחרת, רק תמונות ממוזערות חסרות ייוצרו.',
    'generate_thumbnails_batch_size' => 'גודל אצווה',
    'generate_thumbnails_batch_size_helper' => 'מספר תמונות לעיבוד לכל אצווה. הגדל לעיבוד מהיר יותר אם השרת שלך יכול להתמודד עם זה.',
    'generate_thumbnails_start_offset' => 'היסט התחלתי',
    'generate_thumbnails_start_offset_helper' => 'דלג על מספר תמונות זה מההתחלה. שימושי לחידוש לאחר פסק זמן.',
