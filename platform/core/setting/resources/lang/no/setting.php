...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Vis kom i gang-veiviseren',
            'show_get_started_helper' => 'Vis kom i gang-oppsettveiviseren på dashbordet for nye installasjoner',
    ...
    'email' => [
        ...
        'sendgrid_key' => 'API-nøkkel',
        'sendgrid_key_placeholder' => 'Eks: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Din SendGrid API-nøkkel',
        'default_locale' => 'Standard e-postspråk',
        'default_locale_helper' => 'Velg standardspråk for kunde-e-poster. Når satt til "Auto", vil systemet bruke nettstedets standardspråk. Dette forhindrer at kunde-e-poster sendes på ansattes dashbordspråk.',
        'default_locale_auto' => 'Auto (bruk nettstedets standardspråk)',
        ...
        'template_test' => 'Test e-post',
        'template_test_description' => 'Mal for test-e-poster sendt fra e-postinnstillinger',
        'template_test_subject' => 'Test e-post fra {{ site_title }}',
        'test_email_title' => 'Test av e-postkonfigurasjon',
        'test_email_message' => 'Dette er en test-e-post sendt fra :site_title for å bekrefte at e-postinnstillingene dine er riktig konfigurert.',
        'test_email_success_message' => 'Hvis du mottok denne e-posten, betyr det at SMTP-konfigurasjonen din fungerer riktig.',
        'default' => 'Standard',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Er Wasabi CDN aktivert?',
        'wasabi_cdn_enabled_helper' => 'Når aktivert, vil mediefiler bli servert gjennom et CDN for raskere global innholdslevering. Du må konfigurere et tilpasset CDN-domene nedenfor.',
        'media_wasabi_cdn_custom_domain' => 'Wasabi CDN tilpasset domene',
        'media_wasabi_cdn_custom_domain_placeholder' => 'https://ditt-tilpasset-domene.com',
        ...
        'image_quality' => 'Bildekvalitet',
        'image_quality_helper' => 'Angi kvaliteten for bildekoding (70-100). Lavere verdier gir mindre filer. Standard er 75. Gjelder for opplastede bilder, miniatyrbilder og bilder med vannmerke.',
    ...
    'generate_thumbnails_override' => 'Overskriv eksisterende miniatyrbilder',
    'generate_thumbnails_override_helper' => 'Hvis avkrysset, vil eksisterende miniatyrbilder bli gjenskapt. Ellers vil kun manglende miniatyrbilder bli opprettet.',
    'generate_thumbnails_batch_size' => 'Batchstørrelse',
    'generate_thumbnails_batch_size_helper' => 'Antall bilder som behandles per batch. Øk for raskere behandling hvis serveren din kan håndtere det.',
    'generate_thumbnails_start_offset' => 'Startforskyvning',
    'generate_thumbnails_start_offset_helper' => 'Hopp over dette antallet bilder fra begynnelsen. Nyttig for å gjenoppta etter en tidsavbrudd.',
