...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Mostra procedura guidata iniziale',
            'show_get_started_helper' => 'Mostra la procedura guidata di configurazione iniziale nella dashboard per le nuove installazioni',
    ...
    'email' => [
        ...
        'mail_gun_secret_placeholder' => 'Es: your_mailgun_api_key_here',
        ...
        'sendgrid_key' => 'Chiave API',
        'sendgrid_key_placeholder' => 'Es: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'La tua chiave API SendGrid',
        'default_locale' => 'Lingua predefinita delle email',
        'default_locale_helper' => 'Seleziona la lingua predefinita per le email ai clienti. Quando impostato su "Auto", il sistema utilizzerà la lingua predefinita del sito. Questo impedisce l\'invio delle email ai clienti nella lingua della dashboard del dipendente.',
        'default_locale_auto' => 'Auto (usa la lingua predefinita del sito)',
        ...
        'template_test' => 'Email di prova',
        'template_test_description' => 'Template per le email di prova inviate dalle impostazioni email',
        'template_test_subject' => 'Email di prova da {{ site_title }}',
        'test_email_title' => 'Test configurazione email',
        'test_email_message' => 'Questa è un\'email di prova inviata da :site_title per verificare che le impostazioni email siano configurate correttamente.',
        'test_email_success_message' => 'Se hai ricevuto questa email, significa che la configurazione SMTP funziona correttamente.',
        'default' => 'Predefinito',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'È abilitato Wasabi CDN?',
        'wasabi_cdn_enabled_helper' => 'Se abilitati, i file multimediali verranno serviti tramite una CDN per una distribuzione dei contenuti globale più rapida. È necessario configurare un dominio CDN personalizzato di seguito.',
        'media_wasabi_cdn_custom_domain' => 'Dominio personalizzato CDN Wasabi',
        'media_wasabi_cdn_custom_domain_placeholder' => 'https://tuo-dominio-personalizzato.com',
        ...
        'image_quality_helper' => 'Imposta la qualità di codifica delle immagini (70-100). Valori più bassi producono file più piccoli. Il valore predefinito è 75. Si applica alle immagini caricate, miniature e immagini con filigrana.',
    ...
    'generate_thumbnails_override' => 'Sovrascrivi le miniature esistenti',
    'generate_thumbnails_override_helper' => 'Se selezionato, le miniature esistenti verranno rigenerate. Altrimenti, verranno create solo le miniature mancanti.',
    'generate_thumbnails_batch_size' => 'Dimensione del lotto',
    'generate_thumbnails_batch_size_helper' => 'Numero di immagini da elaborare per lotto. Aumenta per un\'elaborazione più veloce se il tuo server può gestirlo.',
    'generate_thumbnails_start_offset' => 'Offset iniziale',
    'generate_thumbnails_start_offset_helper' => 'Salta questo numero di immagini dall\'inizio. Utile per riprendere dopo un timeout.',
