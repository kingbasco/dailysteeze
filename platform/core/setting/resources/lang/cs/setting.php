...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Zobrazit průvodce začátkem',
            'show_get_started_helper' => 'Zobrazit průvodce nastavením na řídicím panelu pro nové instalace',
    ...
    'email' => [
        ...
        'mail_gun_secret_placeholder' => 'Např.: your_mailgun_api_key_here',
        ...
        'sendgrid_key' => 'Klíč API',
        'sendgrid_key_placeholder' => 'Např.: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Váš klíč SendGrid API',
        'default_locale' => 'Výchozí jazyk e-mailů',
        'default_locale_helper' => 'Vyberte výchozí jazyk pro e-maily zákazníkům. Při nastavení na "Automaticky" systém použije výchozí jazyk webu. Tím se zabrání odesílání e-mailů zákazníkům v jazyce panelu zaměstnance.',
        'default_locale_auto' => 'Automaticky (použít výchozí jazyk webu)',
        ...
        'template_test_description' => 'Šablona pro testovací e-maily odeslané z nastavení e-mailu',
        'template_test_subject' => 'Testovací e-mail z {{ site_title }}',
        'test_email_title' => 'Test konfigurace e-mailu',
        'test_email_message' => 'Toto je testovací e-mail odeslaný z :site_title k ověření, že vaše nastavení e-mailu jsou správně nakonfigurována.',
        'test_email_success_message' => 'Pokud jste obdrželi tento e-mail, znamená to, že vaše konfigurace SMTP funguje správně.',
        'default' => 'Výchozí',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Je CDN Wasabi povoleno?',
        'wasabi_cdn_enabled_helper' => 'Když je tato možnost povolena, mediální soubory budou poskytovány prostřednictvím sítě CDN pro rychlejší globální doručování obsahu. Níže musíte nakonfigurovat vlastní doménu CDN.',
        'media_wasabi_cdn_custom_domain' => 'Vlastní doména Wasabi CDN',
        'media_wasabi_cdn_custom_domain_placeholder' => 'https://vase-vlastni-domena.cz',
        ...
        'image_quality' => 'Kvalita obrázku',
        'image_quality_helper' => 'Nastavte kvalitu kódování obrázků (70-100). Nižší hodnoty vytvářejí menší soubory. Výchozí hodnota je 75. Platí pro nahrané obrázky, miniatury a obrázky s vodoznakem.',
    ...
    'generate_thumbnails_override' => 'Přepsat existující miniatury',
    'generate_thumbnails_override_helper' => 'Pokud je zaškrtnuto, existující miniatury budou znovu vygenerovány. Jinak budou vytvořeny pouze chybějící miniatury.',
    'generate_thumbnails_batch_size' => 'Velikost dávky',
    'generate_thumbnails_batch_size_helper' => 'Počet obrázků ke zpracování na dávku. Zvyšte pro rychlejší zpracování, pokud to váš server zvládne.',
    'generate_thumbnails_start_offset' => 'Počáteční posun',
    'generate_thumbnails_start_offset_helper' => 'Přeskočte tento počet obrázků od začátku. Užitečné pro obnovení po vypršení časového limitu.',
