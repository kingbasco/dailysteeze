...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Rādīt sākšanas vedni',
            'show_get_started_helper' => 'Rādīt sākšanas iestatīšanas vedni informācijas panelī jaunām instalācijām',
    ...
    'email' => [
        ...
        'mail_gun_secret_placeholder' => 'Piemērs: your_mailgun_api_key_here',
        ...
        'sendgrid_key' => 'API atslēga',
        'sendgrid_key_placeholder' => 'Piemērs: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Jūsu SendGrid API atslēga',
        'default_locale' => 'Noklusējuma e-pasta valoda',
        'default_locale_helper' => 'Izvēlieties noklusējuma valodu klientu e-pastiem. Ja iestatīts uz "Automātiski", sistēma izmantos vietnes noklusējuma valodu. Tas novērš klientu e-pastu sūtīšanu darbinieka paneļa valodā.',
        'default_locale_auto' => 'Automātiski (izmantot vietnes noklusējuma valodu)',
        ...
        'template_test' => 'Testa e-pasts',
        'template_test_description' => 'Veidne testa e-pastiem, kas nosūtīti no e-pasta iestatījumiem',
        'template_test_subject' => 'Testa e-pasts no {{ site_title }}',
        'test_email_title' => 'E-pasta konfigurācijas tests',
        'test_email_message' => 'Šis ir testa e-pasts, kas nosūtīts no :site_title, lai pārbaudītu, vai jūsu e-pasta iestatījumi ir pareizi konfigurēti.',
        'test_email_success_message' => 'Ja esat saņēmis šo e-pastu, tas nozīmē, ka jūsu SMTP konfigurācija darbojas pareizi.',
        'default' => 'Noklusējuma',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Vai Wasabi CDN ir iespējots?',
        'wasabi_cdn_enabled_helper' => 'Kad tas ir iespējots, multivides faili tiks apkalpoti, izmantojot CDN, lai nodrošinātu ātrāku globālo satura piegādi. Tālāk ir jākonfigurē pielāgots CDN domēns.',
        'media_wasabi_cdn_custom_domain' => 'Wasabi CDN pielāgots domēns',
        'media_wasabi_cdn_custom_domain_placeholder' => 'https://jusu-pielagotais-domens.lv',
        ...
        'image_quality' => 'Attēla kvalitāte',
        'image_quality_helper' => 'Iestatiet attēlu kodēšanas kvalitāti (70-100). Zemākas vērtības rada mazākus failus. Noklusējums ir 75. Attiecas uz augšupielādētiem attēliem, sīktēliem un attēliem ar ūdenszīmi.',
    ...
    'generate_thumbnails_override' => 'Pārrakstīt esošās sīktēlus',
    'generate_thumbnails_override_helper' => 'Ja atzīmēts, esošie sīktēli tiks ģenerēti no jauna. Pretējā gadījumā tiks izveidoti tikai trūkstošie sīktēli.',
    'generate_thumbnails_batch_size' => 'Paketes lielums',
    'generate_thumbnails_batch_size_helper' => 'Attēlu skaits apstrādei katrā paketē. Palieliniet ātrākai apstrādei, ja jūsu serveris to spēj apstrādāt.',
    'generate_thumbnails_start_offset' => 'Sākuma nobīde',
    'generate_thumbnails_start_offset_helper' => 'Izlaist šo attēlu skaitu no sākuma. Noderīgi atsākšanai pēc taimauta.',
