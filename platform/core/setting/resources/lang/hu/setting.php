...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Kezdő varázsló megjelenítése',
            'show_get_started_helper' => 'A kezdő beállítási varázsló megjelenítése az irányítópulton új telepítésekhez',
    ...
    'email' => [
        ...
        'mail_gun_secret_placeholder' => 'Pl.: your_mailgun_api_key_here',
        ...
        'sendgrid_key' => 'API kulcs',
        'sendgrid_key_placeholder' => 'Pl.: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Az Ön SendGrid API kulcsa',
        'default_locale' => 'Alapértelmezett e-mail nyelv',
        'default_locale_helper' => 'Válassza ki az alapértelmezett nyelvet az ügyfél e-mailekhez. "Automatikus" beállítás esetén a rendszer az oldal alapértelmezett nyelvét használja. Ez megakadályozza, hogy az ügyfél e-mailek a munkatárs irányítópultjának nyelvén kerüljenek kiküldésre.',
        'default_locale_auto' => 'Automatikus (az oldal alapértelmezett nyelvének használata)',
        ...
        'template_test' => 'Teszt e-mail',
        'template_test_description' => 'Sablon az e-mail beállításokból küldött teszt e-mailekhez',
        'template_test_subject' => 'Teszt e-mail a {{ site_title }} oldalról',
        'test_email_title' => 'E-mail konfiguráció teszt',
        'test_email_message' => 'Ez egy teszt e-mail a :site_title oldalról, amellyel ellenőrizheti, hogy az e-mail beállításai megfelelően vannak-e konfigurálva.',
        'test_email_success_message' => 'Ha megkapta ezt az e-mailt, az azt jelenti, hogy az SMTP konfigurációja megfelelően működik.',
        'default' => 'Alapértelmezett',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Engedélyezve van a Wasabi CDN?',
        'wasabi_cdn_enabled_helper' => 'Ha engedélyezve van, a médiafájlok CDN-en keresztül lesznek kiszolgálva a gyorsabb globális tartalomszolgáltatás érdekében. Az alábbiakban egyéni CDN-tartományt kell konfigurálnia.',
        'media_wasabi_cdn_custom_domain' => 'Wasabi CDN egyéni tartomány',
        'media_wasabi_cdn_custom_domain_placeholder' => 'https://az-on-egyeni-tartomanya.com',
        ...
        'image_quality' => 'Képminőség',
        'image_quality_helper' => 'Állítsa be a képkódolás minőségét (70-100). Az alacsonyabb értékek kisebb fájlokat hoznak létre. Az alapértelmezett 75. Vonatkozik a feltöltött képekre, miniatűrökre és vízjeles képekre.',
    ...
    'generate_thumbnails_override' => 'Meglévő miniatűrök felülírása',
    'generate_thumbnails_override_helper' => 'Ha be van jelölve, a meglévő miniatűrök újragenerálódnak. Ellenkező esetben csak a hiányzó miniatűrök jönnek létre.',
    'generate_thumbnails_batch_size' => 'Köteg mérete',
    'generate_thumbnails_batch_size_helper' => 'Kötegenként feldolgozandó képek száma. Növelje a gyorsabb feldolgozás érdekében, ha a szervere képes kezelni.',
    'generate_thumbnails_start_offset' => 'Kezdő eltolás',
    'generate_thumbnails_start_offset_helper' => 'Hagyja ki ennyi képet az elejétől. Hasznos az időtúllépés utáni folytatáshoz.',
