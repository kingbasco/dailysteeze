...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'show_get_started' => 'Visa kom igång-guiden',
            'show_get_started_helper' => 'Visa kom igång-installationsguiden på instrumentpanelen för nya installationer',
    ...
    'email' => [
        ...
        'mail_gun_secret_placeholder' => 'Ex: your_mailgun_api_key_here',
        ...
        'sendgrid_key' => 'API-nyckel',
        'sendgrid_key_placeholder' => 'Ex: SG.xxxxxxxxxxxxxxxxxxxx.xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'sendgrid_key_helper' => 'Din SendGrid API-nyckel',
        'default_locale' => 'Standardspråk för e-post',
        'default_locale_helper' => 'Välj standardspråk för kundmejl. När det är inställt på "Auto" kommer systemet att använda webbplatsens standardspråk. Detta förhindrar att kundmejl skickas på personalens instrumentpanelsspråk.',
        'default_locale_auto' => 'Auto (använd webbplatsens standardspråk)',
        ...
        'template_test' => 'Testmejl',
        'template_test_description' => 'Mall för testmejl som skickas från e-postinställningarna',
        'template_test_subject' => 'Testmejl från {{ site_title }}',
        'test_email_title' => 'Test av e-postkonfiguration',
        'test_email_message' => 'Detta är ett testmejl skickat från :site_title för att verifiera att dina e-postinställningar är korrekt konfigurerade.',
        'test_email_success_message' => 'Om du har fått detta mejl betyder det att din SMTP-konfiguration fungerar korrekt.',
        'default' => 'Standard',
    ...
    'media' => [
        ...
        'wasabi_cdn_enabled' => 'Är Wasabi CDN aktiverad?',
        'wasabi_cdn_enabled_helper' => 'När det är aktiverat kommer mediafiler att serveras via ett CDN för snabbare global innehållsleverans. Du måste konfigurera en anpassad CDN-domän nedan.',
        'media_wasabi_cdn_custom_domain' => 'Wasabi CDN anpassad domän',
        ...
        'image_quality' => 'Bildkvalitet',
        'image_quality_helper' => 'Ställ in kvaliteten för bildkodning (70-100). Lägre värden ger mindre filer. Standard är 75. Gäller för uppladdade bilder, miniatyrbilder och bilder med vattenstämpel.',
    ...
    'generate_thumbnails_override' => 'Skriv över befintliga miniatyrer',
    'generate_thumbnails_override_helper' => 'Om markerat kommer befintliga miniatyrer att återskapas. Annars skapas bara saknade miniatyrer.',
    'generate_thumbnails_batch_size' => 'Batchstorlek',
    'generate_thumbnails_batch_size_helper' => 'Antal bilder att bearbeta per batch. Öka för snabbare bearbetning om din server klarar av det.',
    'generate_thumbnails_start_offset' => 'Startförskjutning',
    'generate_thumbnails_start_offset_helper' => 'Hoppa över detta antal bilder från början. Användbart för att återuppta efter en timeout.',
    ...
    'cache' => [
        ...
        'form' => [
            ...
            'cache_size_warning_threshold' => 'Varningströskel för cachestorlek (MB)',
            'cache_size_warning_threshold_helper' => 'Visar en varning på sidan Cachehantering när ramverkets cache överskrider denna storlek (i MB). Standardvärdet är 50 MB.',
            'cache_auto_clear_enabled' => 'Rensa cache automatiskt när storleken överskrider tröskelvärdet',
            'cache_auto_clear_enabled_helper' => 'Rensar automatiskt ramverkets cache varje timme när dess storlek överskrider varningströskeln ovan. Kräver att Laravel-schemaläggaren (<code>php artisan schedule:run</code>) är konfigurerad som ett cron-jobb på din server.',
        ],
    ],
    'appearance' => [
        'title' => 'Utseende',
