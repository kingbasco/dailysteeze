@php
    ...
    /**
     * Footer Style 6 — light cream variant of style-5. Mirrors home-jewelry.html
     * `tf-footer footer-s5 bg-main-5` (lines 3753-3950+). Same 5-col structure as
     * style-5 (TOP STRIP 4 box-icons + MIDDLE 5 cols + BOTTOM payment list) but
     * with cream `--bg-5: #fdf1e3` background, BLACK text + icons, and subtle
     * cream-tinted dividers/borders instead of style-5's dark+white_10.
     *
     * Top-strip box-icon items reuse the same `footer_service_*` theme options
     * as style-5 so admin-driven copy works for both.
     */
...
{{-- Cream variant footer layout (footer-s5.bg-main-5) lives in
