@php
    /**
     * Style-4 list — flip animation reduces to a wide row in list view
     * (3D flip impractical in horizontal layout). CSS hooks preserved.
     */
...
<div class="card-product__layout card-product-style-4__layout product-style_list d-flex">
