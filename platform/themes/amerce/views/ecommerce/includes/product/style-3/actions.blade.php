@php
    /**
     * Style-3 actions — image-overlay variant. Wired to Botble ecommerce JS via data-bb-toggle.
     */
...
<ul class="product-action_list card-product__actions card-product-style-3__actions">
