@php
    /**
     * Style-2 actions — slide-up variant. Wired to Botble ecommerce JS via data-bb-toggle.
     */
...
<ul class="product-action_list card-product__actions card-product-style-2__actions">
