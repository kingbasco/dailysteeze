@php
    /**
     * Style-2 list card — wide row, slide-up CSS treatment for the info column.
     */
...
<div class="card-product__layout card-product-style-2__layout product-style_list d-flex">
